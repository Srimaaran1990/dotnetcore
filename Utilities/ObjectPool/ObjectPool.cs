...
namespace Common.ObjectPool
{
    ...
    public class ObjectPool<T> where T : PooledObject
    {
        ...
        private const int DefaultPoolMaximumSize = 20;
        ...
        public void SetProperty(object instance, string propertyName, object newValue)
        {
            ...
            foreach (PropertyInfo propertyInfo in type.GetProperties(BindingFlags.NonPublic | BindingFlags.Instance))
            {
        ...
        public void ResetPooledObject( string _propertyName, object newValue)
        {
            foreach (var _pooledObject in PooledObjects)
            {
                SetProperty(_pooledObject, _propertyName, newValue);
            }
        }
        #endregion
